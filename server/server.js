...
app.post('/recipe/', (req, res) => {
    ...
    const newRecipe = new Recipe({
        ...
        nutrition: {
            ...
            fats: req.body.totalNutrients.FAT,
            carbs: req.body.totalNutrients.CHOCDF,
            protein: req.body.totalNutrients.PROCNT
        },
        servings: req.body.yield,
        url: req.body.shareAs,
        image: req.body.image,
        recipeReadable: req.body.ingredientLines,
